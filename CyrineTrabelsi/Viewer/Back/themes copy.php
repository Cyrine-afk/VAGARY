                  ...
                  <div class="form-group row">                     
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" name="search_text" id="search_text" placeholder="Search by influencer's name" class="form-control" >
                        </div>
                      </div>
                  </div>
                  <br>
...
<script>
                          $(document).ready(function(){
                            ...
                            {
                              $.ajax({
                                url:"<?php echo base_url(); ?>themes/fetch",
                                method:"POST",
                                data:{query:query},
