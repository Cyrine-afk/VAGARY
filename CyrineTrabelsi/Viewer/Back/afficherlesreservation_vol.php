...
$listelesreservation_tous_vol=$Reservation_vol_userC->afficherlesreservation_vol($_GET['id']); 
...
<html>
  <head> 
    ...
    <title>Flight reservation's tables</title>
                  ...
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                           <div class="col mr-2">
                                                               ...
                                                               <form method="POST" action="imprimerVol.php">
    ...
    <tr>
      ...
      <th scope="col">prenom du client</th>
        <th scope="col">mail du client</th>     
                <th scope="col">Date de disponibilte de  Vol </th>
...
<form method="POST" action="DeleteReservation_vol_user.php">
  ...
  <button class="btn btn-primary" type="submit"><i class="fa fa-trash"></i> </button>
    ...
    <input type="hidden" value="<?PHP echo $_GET['id']; ?>" name="id_vol"> 
  </form>
