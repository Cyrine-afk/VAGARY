<?php 
    ...
    isset($_POST["insta_inf"]) ) {
      ...
      $newinf= new InfluC();
      $newinf->modifierInfluenceur($inf,$_POST['id_inf']);
            ...
            <div class="row">
              ...
              <?php
                if (isset($_GET['id_inf'])) {
                  $inf2=new InfluC();
                  $i=$inf2->chercherid($_GET['id_inf']); // récupère l'album à modifier de la base
              ?>
                  ...
                  <form class="form-horizontal" method="POST">
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="bio_inf" id="bio_inf" value="<?= $i['bio_inf'] ?>" class="form-control" cols="30" rows="10" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="feedback_inf" id="feedback_inf"  value="<?= $i['feedback_inf'] ?>" class="form-control">
                        </div>
                      </div>
