<?php
    include_once $_SERVER['DOCUMENT_ROOT'].'/projet/VAGARY/CyrineTrabelsi/Model/communaute.php';
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6">
                <div class="block">
                  <div class="title"><strong class="d-block">ajout de communauté</strong></div>
                  <div class="block-body">
                    <form action="" method="POST">
                      <div class="form-group">
                        <label class="form-control-label">Nom communauté</label>
                        <input type="text" placeholder="Nom communauté" name="nom_com" id="nom_com" maxlength="20" class="form-control">
                      </div>
                      <div class="form-group">       
                        <label class="form-control-label">nbr abonné</label>
                        <input type="number" placeholder="nbr ab" name="nbr_ab_com" id="nbr_ab_com" class="form-control">
                      </div>
                      <div class="form-group">       
          ...
          <div class=" col-lg-6">
                <div class="block margin-bottom-sm">
                  <div class="title"><strong>info communauté</strong></div>
