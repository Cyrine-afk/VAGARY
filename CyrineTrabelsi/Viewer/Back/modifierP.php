...
{
	$total++;
	$req="select * from produit where id_prod=".$_GET['id_prod'];
	...
	$result=$db->query($req);
	   ...
	   {   
		   ...
		   $categorie_prod=$row['categorie_prod'];
...
<td><input type="text"  value="<?php echo $nom_prod;?>" class="form-control" name="nom_prod" placeholder="Nom du produit" style="width:400px"> </td></tr>

<tr><td><label> Catégorie </label></td>
<td><input type="text"  value="<?php echo $categorie_prod;?>" class="form-control" name="categorie_prod" placeholder="Catégorie du produit" style="width:400px"> </td></tr>
</td></tr>
<tr><td><label> Prix </label></td>
<td><input type="number" value="<?php echo $prix_prod;?>" class="form-control" name="prix_prod" placeholder="Prix en Dt" style="width:400px"> </td></tr>
<tr><td><img src="img/produit/<?php echo $img_prod;?>" width="100" height="100" /> </td>

<td>
<label for="photo">Choisissez la photo à insérer</label><input type="file" name="img_prod" enctype= "multipart/form-data" /> </td> </tr>
</table>
