    ...
    <section class="py-7 position-relative dark-overlay"><img class="bg-image" src="img/photo/photo-1497436072909-60f360e1d4b1.jpg" alt="">
      <div class="container">
        <div class="overlay-content text-white py-lg-5">
          <h3 class="display-3 font-weight-bold text-serif text-shadow mb-5">Ready for our next level trips?</h3>
          <br>
            ...
            <div class="mb-3 mb-lg-0 col-sm-6 col-lg-3">
              <div class="card border-0 hover-animate bg-transparent">
                <a class="position-relative" href="profile_influ.php?id_inf=<?php echo $elt['id_inf'] ?>">
                  <img class="card-img-top team-img" src="<?php echo $elt['img_inf'] ?>" alt=""/> 
                  <!-- <p> hiiii </p>  --> 
                  <div class="team-circle bg-secondary-light"></div>
                </a>
                  <div class="card-body team-body text-center">
                    <h6 class="card-title"> <?php echo $elt['nom_inf'] ?> <?php echo $elt['prenom_inf'] ?></h6>
                    <p class="card-subtitle text-muted text-xs text-uppercase"><?php echo $elt['nbr_ab_inf'] ?> followers    </p>
                  </div>
              </div>
            </div>
