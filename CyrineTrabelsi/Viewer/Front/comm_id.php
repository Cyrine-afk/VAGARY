                  ...
                  <div class="row">
                    ...
                    <div class="col-9 col-lg-4 align-self-center mb-3 mb-lg-0">
                      <div class="d-flex align-items-center mb-1 mb-lg-3">
                        <h2 class="h5 mb-0"><?PHP echo $avis["nom_client"].' '.$avis["prenom_client"] ?></h2><img class="avatar avatar-sm avatar-border-white ml-3" src="<?php echo $avis["img_client"] ?>" alt="Jack London">
                      </div>
                    ...
                    <div class="col-10 ml-auto col-lg-7">
                      <div class="row">
                        ...
                        <div class="col-md-4 text-right py-3">
                          <p class="text-sm"><?php echo date("Y/m/d") ?></p>
