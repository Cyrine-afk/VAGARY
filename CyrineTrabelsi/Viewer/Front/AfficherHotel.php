  ...
  <header class="header">
    ...
    <section class="py-6 bg-gray-100"> 
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-8">
            <p class="subtitle text-secondary">List Hotel</p>
    ...
    margin-left: 620px;
    margin-top: -11px;
">     <a href="afficherlesreservation_hotel.php" style="
    color: white;
">Mes reservations hotel</a>  </button>
...
foreach($listeHotels as $row){
    if ($row['nbr_places'] != 0 && date($row['date_disponible_Fin']) > date('Y-m-d H:i:s'))
{
  ?>
    <tr>
...
" src="<?php echo $row['image'] ?>"></td>
      ...
      <td><?php echo $row['description'] ?></td>
       <td><?php echo $row['date_disponible_Debut'] ?></td>
      <td><?php echo $row['date_disponible_Fin'] ?></td>
            <td><?php echo $row['nbr_places'] ?></td>
 <td> <a class="btn btn-primary"  href="AjouterReservation_hotel.php?id=<?PHP echo $row['id']; ?>"><i class="fa fa-registered"></i></a>
         </td>
