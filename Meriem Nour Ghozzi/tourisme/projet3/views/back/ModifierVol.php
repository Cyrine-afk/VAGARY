...
if (isset($_GET['id'])){
    ...
    $VolC=new VolC();
    $result=$VolC->recuperervol($_GET['id']);

    foreach($result as $row){
$date_heur_disponible=$row->date_heur_disponible;
...
<div class="col-xl-9 col-md-6 mb-6">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                                                 ...
                                                                 <form  onsubmit="return validateForm()" name="myForm" method="POST" action="ModifierVolC.php" >
 ...
 <input class="form-control"  id="date_heur_disponible" name="date_heur_disponible" value="<?php  echo date('Y-m-d', strtotime($date_heur_disponible)).'T'.date('H:i', strtotime($date_heur_disponible)); ?>" type="datetime-local"   placeholder="date_heur_disponible"   />
                            </div>
