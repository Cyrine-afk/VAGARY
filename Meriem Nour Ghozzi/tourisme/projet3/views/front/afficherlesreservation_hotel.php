...
$listereservation_hotel_user=$Reservation_hotel_userC->affichermesreservation($_SESSION['id']); 
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
foreach($listereservation_hotel_user as $row){
...
" src="../img/<?php echo $row['image'] ?>"></td>
 ...
 <td> <form method="POST" action="DeleteReservation_hotel_user.php">
