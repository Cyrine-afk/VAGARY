        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6">
                <div class="block">
                  <div class="title"><strong class="d-block">ajout de communauté</strong><span class="d-block">*******</span></div>
                  <div class="block-body">
                    <form action="" method="POST">
                      ...
                      <div class="form-group">       
                        ...
                        <input type="number" placeholder="bnr ab" name="nbr_ab_com" id="nbr_ab_com" class="form-control">
                      </div>
                      <div class="form-group">       
