...
<td>
<td>
<form method="POST" action="supprimer_avis.php">
  <button class="btn btn-primary btn-block" type="submit" name="supprimer" value="supprimer" class="ajouter">Supprimer</button>
	<input type="hidden" value="<?PHP echo $row['ID']; ?>" name="Id">
	</form></td>
<td>
<td><a href="modifier_avis.php?Id=<?PHP echo $row['ID']; ?>"> 
	<button class="btn btn-primary btn-block">Modifier</button></a></td></a>
<?php
echo("</tr>");
