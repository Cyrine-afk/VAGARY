        ...
        <section class="no-padding-top">
          <div class="container">
                  ...
                  <div class="table-responsive"> 
                    ...
                    <td><input type="text" id="search" name="search"  class="mr-sm-25 form-control" placeholder="Search"></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="modifierC.php" method="get">
                                    ...
                                    <input type="submit" name="edit" value="edit" style="background-color: #d63031">
                                </form>
