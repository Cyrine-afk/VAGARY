            ...
            <div class="row">
              <div class="col-lg-10">
                <div class="block margin-bottom-sm">
                  ...
                  <form method="POST" action="stat_produit.php">
                  <button align="center" style="width: 300px"  class="btn btn-primary btn-block">STAT</button>
                  </form>
...
echo('<td> <img src="img/produit/'.$prod['img_prod'].'" width="100" height="100" /> </td>'); 
